import TaskWaitingItem from './TaskWaitingItem'

const TaskWaitingTable = () => {
    return (
        <>
            <div className='mx-8 rounded-lg py-3 px-2 bg-white
                            border border-separate border-[var(--yellow-line)]
            ...
            <table class="min-w-full table-auto 
                ...
                <tbody>
                    <tr class="hover:bg-[var(--main-soft)]"><TaskWaitingItem 
                            titulo={"Adaptacion Valvula Y"} 
                            proyecto={"LTR Q"} 
                            categoria={"Integracion"} 
                            fecha={"04/03/26"}></TaskWaitingItem></tr>
                    <tr class="hover:bg-[var(--main-soft)]"><TaskWaitingItem 
                            titulo={"Actualizacion de programa Fuga Burda"} 
                            proyecto={"LTR P/Q"} 
                            categoria={"Intervencion"} 
                            fecha={"09/03/26"}></TaskWaitingItem></tr>

                    <tr class="hover:bg-[var(--main-soft)]"><TaskWaitingItem 
                            titulo={"Integracion Dispositivo 8"} 
                            proyecto={"LTR Q"} 
                            categoria={"Integracion"} 
                            fecha={"24/03/26"}></TaskWaitingItem></tr>

                    <tr class="hover:bg-[var(--main-soft)]"><TaskWaitingItem 
                            titulo={"Integracion de Mesa de Sellos"} 
                            proyecto={"LTR Q"} 
                            categoria={"Integracion"} 
                            fecha={"09/04/26"}></TaskWaitingItem></tr>
...
export default TaskWaitingTable 