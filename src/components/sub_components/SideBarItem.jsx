...
const SidebarItem = ({ to = "/", icon, label, isOpen }) => {
  return (
    <li>
      <Link
        to={to}
        className={`${isOpen ? "justify-start gap-x-4.5 pl-5" : "justify-center"} group text-[18px] font-semibold flex items-center py-4 hover:bg-[var(--secondary-soft)] text-[var(--text-color-menu)]`}
      >
